...
class RBNFPt_ptTest {
 ...
 val fmt = RBNFPt_pt().spelloutOrdinalFeminine
...
assertEquals("uma mil milionésima", fmt.format(1000000000), "1000000000")
assertEquals("uma mil milionésima primeira", fmt.format(1000000001), "1000000001")
assertEquals("uma mil milionésima segunda", fmt.format(1000000002), "1000000002")
assertEquals("duas mil milionésima", fmt.format(2000000000), "2000000000")
assertEquals("duas mil milionésima primeira", fmt.format(2000000001), "2000000001")
assertEquals("duas mil milionésima segunda", fmt.format(2000000002), "2000000002")
  }
  @Test
  fun spelloutOrdinalMasculine() {
 val fmt = RBNFPt_pt().spelloutOrdinalMasculine
...
assertEquals("um mil milionésimo", fmt.format(1000000000), "1000000000")
assertEquals("um mil milionésimo primeiro", fmt.format(1000000001), "1000000001")
assertEquals("um mil milionésimo segundo", fmt.format(1000000002), "1000000002")
assertEquals("dois mil milionésimo", fmt.format(2000000000), "2000000000")
assertEquals("dois mil milionésimo primeiro", fmt.format(2000000001), "2000000001")
assertEquals("dois mil milionésimo segundo", fmt.format(2000000002), "2000000002")
  }
  @Test
  fun spelloutCardinalFeminine() {
 val fmt = RBNFPt_pt().spelloutCardinalFeminine
...
assertEquals("dezasseis", fmt.format(16), "16")
assertEquals("dezassete", fmt.format(17), "17")
assertEquals("dezoito", fmt.format(18), "18")
assertEquals("dezanove", fmt.format(19), "19")
...
assertEquals("um mil milhões", fmt.format(1000000000), "1000000000")
assertEquals("um mil milhões e uma", fmt.format(1000000001), "1000000001")
assertEquals("um mil milhões e duas", fmt.format(1000000002), "1000000002")
assertEquals("dois mil milhões", fmt.format(2000000000), "2000000000")
assertEquals("dois mil milhões e uma", fmt.format(2000000001), "2000000001")
assertEquals("dois mil milhões e duas", fmt.format(2000000002), "2000000002")
  }
  @Test
  fun spelloutCardinalMasculine() {
 val fmt = RBNFPt_pt().spelloutCardinalMasculine
...
assertEquals("um mil milhões", fmt.format(1000000000), "1000000000")
assertEquals("um mil milhões e um", fmt.format(1000000001), "1000000001")
assertEquals("um mil milhões e dois", fmt.format(1000000002), "1000000002")
assertEquals("dois mil milhões", fmt.format(2000000000), "2000000000")
assertEquals("dois mil milhões e um", fmt.format(2000000001), "2000000001")
assertEquals("dois mil milhões e dois", fmt.format(2000000002), "2000000002")
  }
  @Test
  fun spelloutNumbering() {
 val fmt = RBNFPt_pt().spelloutNumbering
assertEquals("menos um", fmt.format(-1), "-1")
assertEquals("zero", fmt.format(0), "0")
assertEquals("zero vírgula dois", fmt.format(0.2), "0.2")
assertEquals("zero vírgula dois três quatro cinco", fmt.format(0.2345), "0.2345")
...
assertEquals("dois mil milhões e dois", fmt.format(2000000002), "2000000002")
 ...
 val fmt = RBNFPt_pt().spelloutNumberingYear
