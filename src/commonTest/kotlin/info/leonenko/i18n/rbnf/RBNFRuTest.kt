...
// nonsense assertEquals("14", fmt.format(14.02251), "14.02251")
    ...
    @Test
    fun spelloutOrdinalPluralInstrumental() {
        val fmt = RBNFRu().spelloutOrdinalPluralInstrumental
// nonsense assertEquals("минус первыми", fmt.format(-1), "-1")
// nonsense assertEquals("нулевыми", fmt.format(0), "0")
// nonsense assertEquals("0,2", fmt.format(0.2), "0.2")
// nonsense assertEquals("0,2", fmt.format(0.2345), "0.2345")
...
// nonsense assertEquals("14", fmt.format(14.02251), "14.02251")
    ...
    @Test
    fun spelloutOrdinalFeminineInstrumental() {
        val fmt = RBNFRu().spelloutOrdinalFeminineInstrumental
// nonsense assertEquals("минус первой", fmt.format(-1), "-1")
// nonsense assertEquals("нулевой", fmt.format(0), "0")
// nonsense assertEquals("0,2", fmt.format(0.2), "0.2")
// nonsense assertEquals("0,2", fmt.format(0.2345), "0.2345")
...
// nonsense assertEquals("14", fmt.format(14.02251), "14.02251")
    ...
    @Test
    fun spelloutOrdinalNeuterInstrumental() {
        val fmt = RBNFRu().spelloutOrdinalNeuterInstrumental
// nonsense assertEquals("минус первым", fmt.format(-1), "-1")
// nonsense assertEquals("нулевым", fmt.format(0), "0")
// nonsense assertEquals("0,2", fmt.format(0.2), "0.2")
// nonsense assertEquals("0,2", fmt.format(0.2345), "0.2345")
...
// nonsense assertEquals("14", fmt.format(14.02251), "14.02251")
    ...
    @Test
    fun spelloutOrdinalMasculineInstrumental() {
        val fmt = RBNFRu().spelloutOrdinalMasculineInstrumental
// nonsense assertEquals("минус первым", fmt.format(-1), "-1")
// nonsense assertEquals("нулевым", fmt.format(0), "0")
// nonsense assertEquals("0,2", fmt.format(0.2), "0.2")
// nonsense assertEquals("0,2", fmt.format(0.2345), "0.2345")
...
// nonsense assertEquals("14", fmt.format(14.02251), "14.02251")
    ...
    @Test
    fun spelloutOrdinalPluralPrepositional() {
        val fmt = RBNFRu().spelloutOrdinalPluralPrepositional
// nonsense assertEquals("минус первых", fmt.format(-1), "-1")
// nonsense assertEquals("нулевых", fmt.format(0), "0")
// nonsense assertEquals("0,2", fmt.format(0.2), "0.2")
// nonsense assertEquals("0,2", fmt.format(0.2345), "0.2345")
...
// nonsense assertEquals("14", fmt.format(14.02251), "14.02251")
    ...
    @Test
    fun spelloutOrdinalFemininePrepositional() {
        val fmt = RBNFRu().spelloutOrdinalFemininePrepositional
// nonsense assertEquals("минус первой", fmt.format(-1), "-1")
// nonsense assertEquals("нулевой", fmt.format(0), "0")
// nonsense assertEquals("0,2", fmt.format(0.2), "0.2")
// nonsense assertEquals("0,2", fmt.format(0.2345), "0.2345")
...
// nonsense assertEquals("14", fmt.format(14.02251), "14.02251")
    ...
    @Test
    fun spelloutOrdinalNeuterPrepositional() {
        val fmt = RBNFRu().spelloutOrdinalNeuterPrepositional
// nonsense assertEquals("минус первом", fmt.format(-1), "-1")
// nonsense assertEquals("нулевом", fmt.format(0), "0")
// nonsense assertEquals("0,2", fmt.format(0.2), "0.2")
// nonsense assertEquals("0,2", fmt.format(0.2345), "0.2345")
...
// nonsense assertEquals("14", fmt.format(14.02251), "14.02251")
    ...
    @Test
    fun spelloutOrdinalMasculinePrepositional() {
        val fmt = RBNFRu().spelloutOrdinalMasculinePrepositional
// nonsense assertEquals("минус первом", fmt.format(-1), "-1")
// nonsense assertEquals("нулевом", fmt.format(0), "0")
// nonsense assertEquals("0,2", fmt.format(0.2), "0.2")
// nonsense assertEquals("0,2", fmt.format(0.2345), "0.2345")
...
// nonsense assertEquals("14", fmt.format(14.02251), "14.02251")
    ...
    @Test
    fun spelloutCardinalPluralInstrumental() {
        val fmt = RBNFRu().spelloutCardinalPluralInstrumental
        assertEquals("минус одними", fmt.format(-1), "-1")
        assertEquals("нулем", fmt.format(0), "0")
        assertEquals("нулем запятая двумя", fmt.format(0.2), "0.2")
        assertEquals("нулем запятая двумя тремя четырьмя пятью", fmt.format(0.2345), "0.2345")
    ...
    fun spelloutCardinalFeminineInstrumental() {
        val fmt = RBNFRu().spelloutCardinalFeminineInstrumental
        assertEquals("минус одной", fmt.format(-1), "-1")
        assertEquals("нулем", fmt.format(0), "0")
        assertEquals("двумя десятыми", fmt.format(0.2), "0.2")
        assertEquals("двумя тысячами тремястами сорока пятью десятитысячными", fmt.format(0.2345), "0.2345")
    ...
    fun spelloutCardinalNeuterInstrumental() {
        val fmt = RBNFRu().spelloutCardinalNeuterInstrumental
        assertEquals("минус одним", fmt.format(-1), "-1")
        assertEquals("нулем", fmt.format(0), "0")
        assertEquals("двумя десятыми", fmt.format(0.2), "0.2")
        assertEquals("двумя тысячами тремястами сорока пятью десятитысячными", fmt.format(0.2345), "0.2345")
    ...
    fun spelloutCardinalMasculineInstrumental() {
        val fmt = RBNFRu().spelloutCardinalMasculineInstrumental
        assertEquals("минус одним", fmt.format(-1), "-1")
        assertEquals("нулем", fmt.format(0), "0")
        assertEquals("двумя десятыми", fmt.format(0.2), "0.2")
        assertEquals("двумя тысячами тремястами сорока пятью десятитысячными", fmt.format(0.2345), "0.2345")
    ...
    @Test
    fun spelloutCardinalPluralPrepositional() {
        val fmt = RBNFRu().spelloutCardinalPluralPrepositional
        assertEquals("минус одних", fmt.format(-1), "-1")
        assertEquals("нуле", fmt.format(0), "0")
        assertEquals("нуле запятая двух", fmt.format(0.2), "0.2")
        assertEquals("нуле запятая двух трех четырех пяти", fmt.format(0.2345), "0.2345")
    ...
    @Test
    fun spelloutCardinalFemininePrepositional() {
        val fmt = RBNFRu().spelloutCardinalFemininePrepositional
        assertEquals("минус одной", fmt.format(-1), "-1")
        assertEquals("нуле", fmt.format(0), "0")
        assertEquals("двух десятых", fmt.format(0.2), "0.2")
        assertEquals("двух тысячах трехстах сорока пяти десятитысячных", fmt.format(0.2345), "0.2345")
    ...
    @Test
    fun spelloutCardinalNeuterPrepositional() {
        val fmt = RBNFRu().spelloutCardinalNeuterPrepositional
        assertEquals("минус одном", fmt.format(-1), "-1")
        assertEquals("нуле", fmt.format(0), "0")
        assertEquals("двух десятых", fmt.format(0.2), "0.2")
        assertEquals("двух тысячах трехстах сорока пяти десятитысячных", fmt.format(0.2345), "0.2345")
    ...
    @Test
    fun spelloutCardinalMasculinePrepositional() {
        val fmt = RBNFRu().spelloutCardinalMasculinePrepositional
        assertEquals("минус одном", fmt.format(-1), "-1")
        assertEquals("нуле", fmt.format(0), "0")
        assertEquals("двух десятых", fmt.format(0.2), "0.2")
        assertEquals("двух тысячах трехстах сорока пяти десятитысячных", fmt.format(0.2345), "0.2345")
