...
class RBNFEsTest {
 ...
 val fmt = RBNFEs().spelloutOrdinalFeminine
...
assertEquals("dos mil millonésima segunda", fmt.format(2000000002), "2000000002")
 ...
 val fmt = RBNFEs().spelloutOrdinalFemininePlural
...
assertEquals("dos mil millonésima segundas", fmt.format(2000000002), "2000000002")
 ...
 val fmt = RBNFEs().spelloutOrdinalMasculine
...
assertEquals("dos mil millonésimo segundo", fmt.format(2000000002), "2000000002")
 ...
 val fmt = RBNFEs().spelloutOrdinalMasculinePlural
...
assertEquals("dos mil millonésimo segundos", fmt.format(2000000002), "2000000002")
 ...
 val fmt = RBNFEs().spelloutOrdinalMasculineAdjective
...
assertEquals("dos mil millonésimo segundo", fmt.format(2000000002), "2000000002")
 ...
 val fmt = RBNFEs().spelloutCardinalFeminine
assertEquals("menos una", fmt.format(-1), "-1")
assertEquals("cero", fmt.format(0), "0")
assertEquals("cero coma dos", fmt.format(0.2), "0.2")
assertEquals("cero coma dos tres cuatro cinco", fmt.format(0.2345), "0.2345")
assertEquals("cero coma cero dos", fmt.format(0.02), "0.02")
assertEquals("cero coma cero dos una tres", fmt.format(0.0213), "0.0213")
assertEquals("cuatro coma siete cinco una", fmt.format(4.751), "4.751")
assertEquals("doce coma cero cinco una", fmt.format(12.051), "12.051")
assertEquals("trece coma cero dos cinco una", fmt.format(13.0251), "13.0251")
assertEquals("catorce coma cero dos dos cinco una", fmt.format(14.02251), "14.02251")
...
assertEquals("dos mil millones dos", fmt.format(2000000002), "2000000002")
 ...
 val fmt = RBNFEs().spelloutCardinalMasculine
assertEquals("menos un", fmt.format(-1), "-1")
assertEquals("cero", fmt.format(0), "0")
assertEquals("cero coma dos", fmt.format(0.2), "0.2")
assertEquals("cero coma dos tres cuatro cinco", fmt.format(0.2345), "0.2345")
assertEquals("cero coma cero dos", fmt.format(0.02), "0.02")
assertEquals("cero coma cero dos un tres", fmt.format(0.0213), "0.0213")
assertEquals("cuatro coma siete cinco un", fmt.format(4.751), "4.751")
assertEquals("doce coma cero cinco un", fmt.format(12.051), "12.051")
assertEquals("trece coma cero dos cinco un", fmt.format(13.0251), "13.0251")
assertEquals("catorce coma cero dos dos cinco un", fmt.format(14.02251), "14.02251")
...
assertEquals("dos mil millones dos", fmt.format(2000000002), "2000000002")
 ...
 val fmt = RBNFEs().spelloutNumbering
assertEquals("menos uno", fmt.format(-1), "-1")
assertEquals("cero", fmt.format(0), "0")
assertEquals("cero coma dos", fmt.format(0.2), "0.2")
assertEquals("cero coma dos tres cuatro cinco", fmt.format(0.2345), "0.2345")
assertEquals("cero coma cero dos", fmt.format(0.02), "0.02")
assertEquals("cero coma cero dos uno tres", fmt.format(0.0213), "0.0213")
assertEquals("cuatro coma siete cinco uno", fmt.format(4.751), "4.751")
assertEquals("doce coma cero cinco uno", fmt.format(12.051), "12.051")
assertEquals("trece coma cero dos cinco uno", fmt.format(13.0251), "13.0251")
assertEquals("catorce coma cero dos dos cinco uno", fmt.format(14.02251), "14.02251")
...
assertEquals("dos mil millones dos", fmt.format(2000000002), "2000000002")
 ...
 val fmt = RBNFEs().spelloutNumberingYear
