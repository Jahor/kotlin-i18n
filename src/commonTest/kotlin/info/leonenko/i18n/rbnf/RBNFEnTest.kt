...
class RBNFEnTest {
    ...
    fun spelloutOrdinalVerbose() {
        val fmt = RBNFEn().spelloutOrdinalVerbose
...
// nonsense assertEquals("14", fmt.format(14.02251), "14.02251")
    ...
    @Test
    fun spelloutOrdinal() {
        val fmt = RBNFEn().spelloutOrdinal
// nonsense assertEquals("minus first", fmt.format(-1), "-1")
// nonsense assertEquals("zeroth", fmt.format(0), "0")
// nonsense assertEquals("0.2", fmt.format(0.2), "0.2")
// nonsense assertEquals("0.2", fmt.format(0.2345), "0.2345")
...
// nonsense assertEquals("14", fmt.format(14.02251), "14.02251")
    ...
    fun spelloutCardinalVerbose() {
        val fmt = RBNFEn().spelloutCardinalVerbose
        ...
        assertEquals("one hundred thousand", fmt.format(100000), "100000")
        assertEquals("one hundred thousand and one", fmt.format(100001), "100001")
        assertEquals("one hundred thousand and two", fmt.format(100002), "100002")
        assertEquals("two hundred thousand", fmt.format(200000), "200000")
        assertEquals("two hundred thousand and one", fmt.format(200001), "200001")
        assertEquals("two hundred thousand and two", fmt.format(200002), "200002")
        assertEquals("one million", fmt.format(1000000), "1000000")
        assertEquals("one million and one", fmt.format(1000001), "1000001")
        assertEquals("one million and two", fmt.format(1000002), "1000002")
        assertEquals("two million", fmt.format(2000000), "2000000")
        assertEquals("two million and one", fmt.format(2000001), "2000001")
        assertEquals("two million and two", fmt.format(2000002), "2000002")
        assertEquals("ten million", fmt.format(10000000), "10000000")
        assertEquals("ten million and one", fmt.format(10000001), "10000001")
        assertEquals("ten million and two", fmt.format(10000002), "10000002")
        assertEquals("twenty million", fmt.format(20000000), "20000000")
        assertEquals("twenty million and one", fmt.format(20000001), "20000001")
        assertEquals("twenty million and two", fmt.format(20000002), "20000002")
        assertEquals("one hundred million", fmt.format(100000000), "100000000")
        assertEquals("one hundred million and one", fmt.format(100000001), "100000001")
        assertEquals("one hundred million and two", fmt.format(100000002), "100000002")
        assertEquals("two hundred million", fmt.format(200000000), "200000000")
        assertEquals("two hundred million and one", fmt.format(200000001), "200000001")
        assertEquals("two hundred million and two", fmt.format(200000002), "200000002")
        assertEquals("one billion", fmt.format(1000000000), "1000000000")
        assertEquals("one billion and one", fmt.format(1000000001), "1000000001")
        assertEquals("one billion and two", fmt.format(1000000002), "1000000002")
        assertEquals("two billion", fmt.format(2000000000), "2000000000")
        assertEquals("two billion and one", fmt.format(2000000001), "2000000001")
        assertEquals("two billion and two", fmt.format(2000000002), "2000000002")
    }

    @Test
    fun spelloutCardinal() {
        val fmt = RBNFEn().spelloutCardinal
        assertEquals("minus one", fmt.format(-1), "-1")
        assertEquals("zero", fmt.format(0), "0")
        assertEquals("zero point two", fmt.format(0.2), "0.2")
        assertEquals("zero point two three four five", fmt.format(0.2345), "0.2345")
        ...
        assertEquals("one hundred thousand", fmt.format(100000), "100000")
        assertEquals("one hundred thousand one", fmt.format(100001), "100001")
        assertEquals("one hundred thousand two", fmt.format(100002), "100002")
        assertEquals("two hundred thousand", fmt.format(200000), "200000")
        assertEquals("two hundred thousand one", fmt.format(200001), "200001")
        assertEquals("two hundred thousand two", fmt.format(200002), "200002")
        assertEquals("one million", fmt.format(1000000), "1000000")
        assertEquals("one million one", fmt.format(1000001), "1000001")
        assertEquals("one million two", fmt.format(1000002), "1000002")
        assertEquals("two million", fmt.format(2000000), "2000000")
        assertEquals("two million one", fmt.format(2000001), "2000001")
        assertEquals("two million two", fmt.format(2000002), "2000002")
        assertEquals("ten million", fmt.format(10000000), "10000000")
        assertEquals("ten million one", fmt.format(10000001), "10000001")
        assertEquals("ten million two", fmt.format(10000002), "10000002")
        assertEquals("twenty million", fmt.format(20000000), "20000000")
        assertEquals("twenty million one", fmt.format(20000001), "20000001")
        assertEquals("twenty million two", fmt.format(20000002), "20000002")
        assertEquals("one hundred million", fmt.format(100000000), "100000000")
        assertEquals("one hundred million one", fmt.format(100000001), "100000001")
        assertEquals("one hundred million two", fmt.format(100000002), "100000002")
        assertEquals("two hundred million", fmt.format(200000000), "200000000")
        assertEquals("two hundred million one", fmt.format(200000001), "200000001")
        assertEquals("two hundred million two", fmt.format(200000002), "200000002")
        assertEquals("one billion", fmt.format(1000000000), "1000000000")
        assertEquals("one billion one", fmt.format(1000000001), "1000000001")
        assertEquals("one billion two", fmt.format(1000000002), "1000000002")
        assertEquals("two billion", fmt.format(2000000000), "2000000000")
        assertEquals("two billion one", fmt.format(2000000001), "2000000001")
        assertEquals("two billion two", fmt.format(2000000002), "2000000002")
    }

    @Test
    fun spelloutNumberingVerbose() {
        val fmt = RBNFEn().spelloutNumberingVerbose
        assertEquals("minus one", fmt.format(-1), "-1")
        assertEquals("zero", fmt.format(0), "0")
        assertEquals("zero point two", fmt.format(0.2), "0.2")
        assertEquals("zero point two three four five", fmt.format(0.2345), "0.2345")
    ...
    fun spelloutNumbering() {
        val fmt = RBNFEn().spelloutNumbering
        assertEquals("minus one", fmt.format(-1), "-1")
        assertEquals("zero", fmt.format(0), "0")
        assertEquals("zero point two", fmt.format(0.2), "0.2")
        assertEquals("zero point two three four five", fmt.format(0.2345), "0.2345")
    ...
    fun spelloutNumberingYear() {
        val fmt = RBNFEn().spelloutNumberingYear
