...
class RBNFFr_beTest {
 ...
 val fmt = RBNFFr_be().spelloutOrdinalFeminine
...
assertEquals("nonante-huitième", fmt.format(98), "98")
assertEquals("nonante-neuvième", fmt.format(99), "99")
...
assertEquals("neuf cent nonante-huitième", fmt.format(998), "998")
assertEquals("neuf cent nonante-neuvième", fmt.format(999), "999")
...
assertEquals("mille neuf cent nonante-huitième", fmt.format(1998), "1998")
assertEquals("mille neuf cent nonante-neuvième", fmt.format(1999), "1999")
...
assertEquals("neuf mille neuf cent nonante-huitième", fmt.format(9998), "9998")
assertEquals("neuf mille neuf cent nonante-neuvième", fmt.format(9999), "9999")
...
assertEquals("deux milliard deuxième", fmt.format(2000000002), "2000000002")
 ...
 val fmt = RBNFFr_be().spelloutOrdinalFemininePlural
...
assertEquals("nonante-huitièmes", fmt.format(98), "98")
assertEquals("nonante-neuvièmes", fmt.format(99), "99")
...
assertEquals("neuf cent nonante-huitièmes", fmt.format(998), "998")
assertEquals("neuf cent nonante-neuvièmes", fmt.format(999), "999")
...
assertEquals("mille neuf cent nonante-huitièmes", fmt.format(1998), "1998")
assertEquals("mille neuf cent nonante-neuvièmes", fmt.format(1999), "1999")
...
assertEquals("neuf mille neuf cent nonante-huitièmes", fmt.format(9998), "9998")
assertEquals("neuf mille neuf cent nonante-neuvièmes", fmt.format(9999), "9999")
...
assertEquals("deux milliard deuxièmes", fmt.format(2000000002), "2000000002")
 ...
 val fmt = RBNFFr_be().spelloutOrdinalMasculine
...
assertEquals("deux milliard deuxième", fmt.format(2000000002), "2000000002")
 ...
 val fmt = RBNFFr_be().spelloutOrdinalMasculinePlural
...
assertEquals("deux milliard deuxièmes", fmt.format(2000000002), "2000000002")
 ...
 val fmt = RBNFFr_be().spelloutCardinalFeminine
...
assertEquals("nonante-huit", fmt.format(98), "98")
assertEquals("nonante-neuf", fmt.format(99), "99")
assertEquals("cent", fmt.format(100), "100")
assertEquals("cent une", fmt.format(101), "101")
assertEquals("cent deux", fmt.format(102), "102")
assertEquals("neuf cent nonante-huit", fmt.format(998), "998")
assertEquals("neuf cent nonante-neuf", fmt.format(999), "999")
...
assertEquals("mille neuf cent nonante-huit", fmt.format(1998), "1998")
assertEquals("mille neuf cent nonante-neuf", fmt.format(1999), "1999")
...
assertEquals("neuf mille neuf cent nonante-huit", fmt.format(9998), "9998")
assertEquals("neuf mille neuf cent nonante-neuf", fmt.format(9999), "9999")
...
assertEquals("deux milliards deux", fmt.format(2000000002), "2000000002")
 ...
 val fmt = RBNFFr_be().spelloutCardinalMasculine
...
assertEquals("deux milliards deux", fmt.format(2000000002), "2000000002")
 ...
 val fmt = RBNFFr_be().spelloutNumbering
assertEquals("moins un", fmt.format(-1), "-1")
assertEquals("zéro", fmt.format(0), "0")
assertEquals("zéro virgule deux", fmt.format(0.2), "0.2")
assertEquals("zéro virgule deux trois quatre cinq", fmt.format(0.2345), "0.2345")
...
assertEquals("deux milliards deux", fmt.format(2000000002), "2000000002")
 ...
 val fmt = RBNFFr_be().spelloutNumberingYear
...
assertEquals("mille un", fmt.format(1001), "1001")
assertEquals("mille deux", fmt.format(1002), "1002")
assertEquals("dix-neuf-cent nonante-huit", fmt.format(1998), "1998")
assertEquals("dix-neuf-cent nonante-neuf", fmt.format(1999), "1999")
assertEquals("deux mille", fmt.format(2000), "2000")
assertEquals("deux mille un", fmt.format(2001), "2001")
assertEquals("deux mille deux", fmt.format(2002), "2002")
assertEquals("neuf mille neuf cent nonante-huit", fmt.format(9998), "9998")
