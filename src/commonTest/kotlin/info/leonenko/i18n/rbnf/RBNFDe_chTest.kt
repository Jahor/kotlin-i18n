...
class RBNFDe_chTest {
    ...
    fun spelloutOrdinalM() {
        val fmt = RBNFDe_ch().spelloutOrdinalM
...
// nonsense assertEquals("14", fmt.format(14.02251), "14.02251")
        ...
        assertEquals("dreissigstem", fmt.format(30), "30")
        assertEquals("ein­und­dreissigstem", fmt.format(31), "31")
    ...
    fun spelloutOrdinalS() {
        val fmt = RBNFDe_ch().spelloutOrdinalS
...
// nonsense assertEquals("14", fmt.format(14.02251), "14.02251")
        ...
        assertEquals("dreissigstes", fmt.format(30), "30")
        assertEquals("ein­und­dreissigstes", fmt.format(31), "31")
    ...
    fun spelloutOrdinalR() {
        val fmt = RBNFDe_ch().spelloutOrdinalR
...
// nonsense assertEquals("14", fmt.format(14.02251), "14.02251")
        ...
        assertEquals("dreissigster", fmt.format(30), "30")
        assertEquals("ein­und­dreissigster", fmt.format(31), "31")
    ...
    fun spelloutOrdinalN() {
        val fmt = RBNFDe_ch().spelloutOrdinalN
...
// nonsense assertEquals("14", fmt.format(14.02251), "14.02251")
        ...
        assertEquals("dreissigsten", fmt.format(30), "30")
        assertEquals("ein­und­dreissigsten", fmt.format(31), "31")
    ...
    @Test
    fun spelloutOrdinal() {
        val fmt = RBNFDe_ch().spelloutOrdinal
...
// nonsense assertEquals("14", fmt.format(14.02251), "14.02251")
        ...
        assertEquals("dreissigste", fmt.format(30), "30")
        assertEquals("ein­und­dreissigste", fmt.format(31), "31")
    ...
    fun spelloutCardinalM() {
        val fmt = RBNFDe_ch().spelloutCardinalM
        ...
        assertEquals("dreissig", fmt.format(30), "30")
        assertEquals("ein­und­dreissig", fmt.format(31), "31")
    ...
    fun spelloutCardinalS() {
        val fmt = RBNFDe_ch().spelloutCardinalS
    ...
    fun spelloutCardinalR() {
        val fmt = RBNFDe_ch().spelloutCardinalR
    ...
    fun spelloutCardinalN() {
        val fmt = RBNFDe_ch().spelloutCardinalN
    ...
    fun spelloutCardinalFeminine() {
        val fmt = RBNFDe_ch().spelloutCardinalFeminine
    ...
    fun spelloutCardinalMasculine() {
        val fmt = RBNFDe_ch().spelloutCardinalMasculine
    ...
    fun spelloutCardinalNeuter() {
        val fmt = RBNFDe_ch().spelloutCardinalNeuter
        assertEquals("minus ein", fmt.format(-1), "-1")
        assertEquals("null", fmt.format(0), "0")
        assertEquals("null Komma zwei", fmt.format(0.2), "0.2")
        assertEquals("null Komma zwei drei vier fünf", fmt.format(0.2345), "0.2345")
    ...
    fun spelloutNumbering() {
        val fmt = RBNFDe_ch().spelloutNumbering
    ...
    fun spelloutNumberingYear() {
        val fmt = RBNFDe_ch().spelloutNumberingYear
