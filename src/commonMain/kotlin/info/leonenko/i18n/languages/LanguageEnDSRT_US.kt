...
val Language.Companion.enDSRT_US
    get() = languageEnDSRT_US
private val languageEnDSRT_US = LanguageEnDSRT_US()

class LanguageEnDSRT_US internal constructor() : LanguageEnDSRT() {
    override val code: String = "en-Dsrt_US"
    override val script: String = "Dsrt"
    override val territory: String = "US"

    class EllipsisLanguage internal constructor() : LanguageEnDSRT.EllipsisLanguage() {
    }

    override val ellipsis: EllipsisLanguage
        get() = EllipsisLanguage()

    class ListLanguage internal constructor(ellipsis: EllipsisLanguage) : LanguageEnDSRT.ListLanguage(ellipsis) {
    }

    override val list: ListLanguage
        get() = ListLanguage(ellipsis)

    class MeasurementUnitLanguage internal constructor() : LanguageEnDSRT.MeasurementUnitLanguage() {
    }

    override val measurementUnits: MeasurementUnitLanguage
        get() = MeasurementUnitLanguage()

    class NumberLanguage internal constructor() : LanguageEnDSRT.NumberLanguage() {
    }
