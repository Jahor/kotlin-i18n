...
import info.leonenko.i18n.languages.en_IN
import kotlin.math.roundToLong


class RBNFEn_in(language: Language = Language.en_IN) : RBNFEn(language) {
        ...
        private inner class SpelloutCardinal : NumberFormatter {
            ...
            override fun format(value: Long): String {
                ...
                return when (value) {
                    ...
                    in 100000L..9999999L -> {
                        var result = format((value) / 100000)
                        result += " lakh"
                        result += (if ((value) % 100000 == 0L) {
                            ""
                        } else {
                            " " + format(value % 100000)
                        })
                    ...
                    in 10000000L..999999999999L -> {
                        var result = format((value) / 10000000)
                        result += " crore"
                        result += (if ((value) % 10000000 == 0L) {
                            ""
                        } else {
        ...
        private inner class SpelloutCardinalVerbose : NumberFormatter {
            ...
            override fun format(value: Long): String {
                ...
                return when (value) {
                    ...
                    in 100000L..9999999L -> format((value) / 100000) + " lakh" + (if ((value) % 100000 == 0L) "" else commas.format(value % 100000))
                    in 10000000L..999999999999L -> format((value) / 10000000) + " crore" + (if ((value) % 10000000 == 0L) "" else commas.format(value % 10000000))
    ...
    override val spelloutNumberingVerbose: NumberFormatter
