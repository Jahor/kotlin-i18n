...
import info.leonenko.i18n.languages.fr_CH
import kotlin.math.roundToLong


class RBNFFr_ch(language: Language = Language.fr_CH) : RBNFFr(language) {
        ...
        private inner class SpelloutOrdinal : NumberFormatter {
            override fun format(value: Double): String {
                return when (value.roundToLong()) {
                    ...
                    80L -> "huitantième"
                    in 81L..89L -> "huitante-" + etUnieme.format(value % 10)
                    90L -> "nonantième"
            ...
            fun formatF(value: Double): String {
                return when (listOf<Long>(
                    ...
                    80L -> "huitantième"
                    81L -> "huitante-" + etUnieme.format(value % 10)
                    90L -> "nonantième"
