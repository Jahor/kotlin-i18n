...
import info.leonenko.i18n.languages.de_CH
import kotlin.math.roundToLong


class RBNFDe_ch(language: Language = Language.de_CH) : RBNFDe(language) {
    ...
    override val spelloutCardinalNeuter: NumberFormatter
    ...
    override val spelloutCardinalN: NumberFormatter
        get() = spelloutRules.spelloutCardinalN
    override val spelloutCardinalR: NumberFormatter
        get() = spelloutRules.spelloutCardinalR
    override val spelloutCardinalS: NumberFormatter
        get() = spelloutRules.spelloutCardinalS
    override val spelloutCardinalM: NumberFormatter
        get() = spelloutRules.spelloutCardinalM
    override val spelloutOrdinal: NumberFormatter
        get() = spelloutRules.spelloutOrdinal
    override val spelloutOrdinalN: NumberFormatter
        get() = spelloutRules.spelloutOrdinalN
    override val spelloutOrdinalR: NumberFormatter
        get() = spelloutRules.spelloutOrdinalR
    override val spelloutOrdinalS: NumberFormatter
        get() = spelloutRules.spelloutOrdinalS
    override val spelloutOrdinalM: NumberFormatter
